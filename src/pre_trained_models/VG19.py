...
def vg_19_get_features(run_evaluation_model=False):
    def run_model():
        print("here")
    ...
    if os.path.exists("./pre_saved_features/vg19trainfeatures.npy"):
        x_train_feature_map = \
            np.load("./pre_saved_features/vg19trainfeatures.npy")
        x_test_feature_map = \
            np.load("./pre_saved_features/vg19testfeatures.npy")
    else:
        ...
        np.save("./pre_saved_features/vg19testfeatures", x_test_feature_map)
